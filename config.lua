...
Config.IgnoreEntityList = {
    [GetHashKey("gabz_pinkcage")] = true,
    [GetHashKey("furnitured_lowapart")] = true,
    [GetHashKey("furnitured_motel")] = true,
    [GetHashKey("playerhouse_tier1")] = true,
    [GetHashKey("trevors_shell")] = true,
    [GetHashKey("tante_shell")] = true,
    [GetHashKey("micheal_shell")] = true,
    [GetHashKey("frankelientje")] = true,
    [GetHashKey("caravan_shell")] = true,
    [GetHashKey("shell_highend")] = true,
    [GetHashKey("shell_highendv2")] = true,
    [GetHashKey("shell_lester")] = true,
    [GetHashKey("shell_ranch")] = true,
    [GetHashKey("shell_warehouse1")] = true,
    [GetHashKey("shell_warehouse2")] = true,
    [GetHashKey("shell_warehouse3")] = true,
    [GetHashKey("shell_store3")] = true,
    [GetHashKey("shell_officebig")] = true,
    [GetHashKey("shell_weed")] = true,
}
